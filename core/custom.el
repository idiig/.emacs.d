...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(org-agenda-date ((t (:weight bold :height 1))))
 '(org-agenda-date-today ((t (:inherit org-agenda-date :weight bold :height 1.1))))
 '(org-agenda-date-weekend ((t (:weight bold :height 1.2))))
 '(org-agenda-structure ((t (:weight bold :height 1.05))))
 '(org-document-title ((t (:weight bold :height 1.1))))
 '(org-level-1 ((t (:extend nil :weight bold :height 1.2)))))
