...
(defun idiig//org-declare-prefixes-for-mode ()
  ...
  (which-key-declare-prefixes "SPC mz" "zetteldeft")
  (which-key-declare-prefixes ",C" "clocks")
  (which-key-declare-prefixes ",d" "schedule")
  (which-key-declare-prefixes ",i" "insert/add/set")
  (which-key-declare-prefixes ",s" "subtree")
  (which-key-declare-prefixes ",t" "table")
  (which-key-declare-prefixes ",td" "table delete")
  (which-key-declare-prefixes ",tt" "table toggle")
  (which-key-declare-prefixes ",ti" "table insert")
  (which-key-declare-prefixes ",b" "babel")
  (which-key-declare-prefixes ",T" "toggle")
  (which-key-declare-prefixes ",x" "region manipulation")
  (which-key-declare-prefixes ",f" "feed")
  (which-key-declare-prefixes ",z" "zetteldeft"))
